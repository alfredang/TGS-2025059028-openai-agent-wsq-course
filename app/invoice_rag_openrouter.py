...
# Initialize OpenRouter client (using OpenAI-compatible endpoint)
...
def index_pdf(pdf_file, filename: str) -> int:
    ...
    try:
        ...
        embeddings = openrouter_client.embeddings.create(
...
def retrieve_context(question: str) -> str:
    ...
    q_embedding = openrouter_client.embeddings.create(
        model="openai/text-embedding-3-small",
        input=question
    ).data[0].embedding
